...
$fromdateCompare = date('Y-m-d', strtotime($fromdate));
$todateCompare = date('Y-m-d', strtotime($todate));
$currentDate = date('Y-m-d');
if($fromdateCompare < $currentDate){
                $error=" FromDate should not be less than current date ";
           } elseif($todateCompare <= $fromdateCompare){
...
<input placeholder="" id="mask1" name="fromdate" class="masked" type="text" value="<?php echo date('m/d/Y'); ?>" readonly required>
</div>
<div class="input-field col m6 s12">
