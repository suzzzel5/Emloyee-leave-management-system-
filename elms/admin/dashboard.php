                    ...
                    <div class="row no-m-t no-m-b">
                        <div class="col s15 m12 l12">
                            <div class="card invoices-card">
                                <div class="card-content">
                                    <span class="card-title">Latest Registered Employees</span>
                                    <table class="display responsive-table ">
                                        ...
                                        <tbody>
<?php $sql = "SELECT EmpId,FirstName,LastName,Department,RegDate,id FROM tblemployees ORDER BY RegDate DESC LIMIT 5";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$cnt=1;
...
{               ?>
                                            <tr>
                                                ...
                                                <td><a href="editemployee.php?empid=<?php echo htmlentities($result->id);?>" class="waves-effect waves-light btn blue m-b-xs">View</a></td>
                                            </tr>
<?php $cnt++;} }?>
                                        </tbody>
                                    </table>
